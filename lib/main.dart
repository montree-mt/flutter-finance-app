...
import 'package:flutter_finance_app/data/current_activity_mock.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:iconsax/iconsax.dart';

import 'const.dart';
import 'data/send_recent_mock.dart';
...
class _MainPageState extends State<MainPage>
            ...
            itemBuilder: (context, index) => ListTile(
              ...
              trailing: Column(
                ...
                children: [
                  ...
                  Text(
                    '${currentActivity[index].expenseType == 1 ? 'Incomming transfers' : 'Outing transfers'}',
                    style: GoogleFonts.poppins(
                        fontSize: 13, fontWeight: FontWeight.w400),
                  ),
                ],
  ...
  Container _recentsend(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: Color(0xff0a1a34)),
      child: Container(
        decoration: const BoxDecoration(
          color: Colors.white,
